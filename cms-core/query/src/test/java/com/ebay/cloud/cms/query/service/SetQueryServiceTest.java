...
//        raptorContext.setHint(1);
    ...
    public void testMultipleUnion() {
        String query = "Compute[@fqdns=\"slc4b01c-197nh1686qs.stratus.slc.ebay.com\"]{*}.(parentCluster[@_oid=\"CLguf6sdle\"] || activeManifestRef[@_oid=\"B-N-D-1.20111108154904.0\"] || activeManifestCur[@_oid=\"Black-Pearl-1.20111103221326.0\"])";
    ...
    public void testMultipleUnion02() {
        String query = "Compute[@fqdns=\"slc4b01c-197nh1686qs.stratus.slc.ebay.com\"]{*}.(parentCluster[@_oid=\"CLguf6sdle-invalid\"] || activeManifestRef[@_oid=\"B-N-D-1.20111108154904.0-unknown\"] || activeManifestCur[@_oid=\"Black-Pearl-1.20111103221326.0-unknown\"])";
        IQueryResult result = queryService.query(query, stratusContext);
        Assert.assertEquals(0, result.getEntities().size());
    }
    ...
    public void testMultipleUnion03() {
        String query = "Compute[@fqdns=\"slc4b01c-197nh1686qs.stratus.slc.ebay.com\"]{*}." +
...
//    }
    ...
    public void testSameCostSubSet01() {
        ...
        String query = "DNSRecord.(fqdn[@resourceId=~\"a.*\"] && networkAddress{@address,@resourceId})";
