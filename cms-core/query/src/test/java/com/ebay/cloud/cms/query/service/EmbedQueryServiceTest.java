...
public class EmbedQueryServiceTest extends MongoBaseTest {
    ...
    public void integerNot() {
        ...
        // case 1
        String query = "NodeServer.capacities[@resourceId=\"10.7.2.57:slot\" and not @total != -2]";
        result = queryService.query(query, cmsdbContext);
        Assert.assertEquals(0, result.getEntities().size());

        // case 2
        String notQuery = "NodeServer.capacities[@resourceId=\"10.7.2.57:slot\" and not @total != 2 ]";
    ...
    public void testRefEmbed06() {
        ...
        String query = "AssetServer{@resourceId}.( networkControllers.port.networkPorts!Vlan[@resourceId=\"lvs2-ra004:1\"] && nodeServer.capacities{@resourceId, @total})";
